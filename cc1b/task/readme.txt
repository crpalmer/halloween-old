       ...
       =================================================
       README file for the CC1B C compiler, DEMO edition
       =================================================

Welcome to the CC1B C compiler for the UBICOM SX devices. The DEMO
edition can generate up to 700 words of code in a single module with
full optimization and support for 32 bit variables.

The DEMO edition supports the LEANSLICE multitasking consept.
...
--------------
  ...
  cc1b.exe      : CC1B compiler, LEANSLICE DEMO edition
  ...
  mventil.c     : multitasking example
  msg.h         : multitasking message library
  binsem.h      : multitasking binary semaphore library
  semaphore.h   : multitasking semaphore library
  event.h       : multitasking event library
  delay.h       : multitasking delay and timing library
  ...
  math24m.h     : 8-24 bit multiply, speed, signed and unsigned
  ...
  math32f.h  (2): 32 bit floating point library
  math24lb.h (2): 24 bit floating point math functions (log,sqrt,cos,..)
  math32lb.h (2): 32 bit floating point math functions (log,sqrt,cos,..)

  (1) : Not available on the STANDARD and DEMO editions
  (2) : Not available on the DEMO edition
