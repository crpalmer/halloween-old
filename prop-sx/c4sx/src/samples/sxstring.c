// sxstring.c : test a few of the string.h and stdlib.h functions
...
//                    note see the sxio.h for the layout of the serial pins
//
...
void doit(void){
	...
	bank2 char buffer1[16];
	bank3 char buffer2[16];
	bank4 char buffer3[16];
	bank5 char buffer4[16];
	bank6 char buffer5[16];
	bank7 char buffer6[8];
